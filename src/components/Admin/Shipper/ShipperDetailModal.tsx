      ...
      <div className="bg-white rounded-lg p-6 max-w-3xl w-full m-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-mono-50 rounded-lg p-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <span className="text-mono-600">H? tên:</span>{" "}
            ...
            <div>
              <span className="text-mono-600">Tr?ng thái:</span>{" "}
              <span
        ...
        <div className="bg-mono-50 rounded-lg p-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm mb-3">
            <div>
              <span className="text-mono-600">Ðon dang giao:</span>{" "}
        ...
        {loading ? (
          ...
          <div className="bg-mono-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-lg p-3 text-center">
                <p className="text-mono-600 text-xs mb-1">T? l? thành công</p>
            ...
            {stats.activeOrders > 0 && (
              <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                <p className="text-sm text-yellow-800">
                  ?? Ðang có <strong>{stats.activeOrders}</strong> don hàng dang
                  giao
                </p>
              </div>
            )}
