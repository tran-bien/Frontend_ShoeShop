  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-mono-800">Qu?n lý Shipper</h1>
        <button
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-mono-600">Tr?ng thái</span>
                ...
                {/* Active Orders */}
                <div className="flex items-center justify-between">
                  <span className="text-sm text-mono-600">Ðon dang giao</span>
                ...
                <div className="grid grid-cols-3 gap-2 pt-4 border-t">
                  <div className="text-center">
                    <div className="text-xs text-mono-500">T?ng</div>
                  ...
                  <div className="text-center">
                    <div className="text-xs text-mono-500">Th?t b?i</div>
                    <div className="text-lg font-bold text-mono-900">
