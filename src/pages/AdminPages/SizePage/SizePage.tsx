      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-mono-black to-purple-600 text-white p-6 rounded-t-xl">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold">Chi ti?t Kích thu?c</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-sm text-mono-500 font-medium">Giá tr? size</p>
...
const EditSizeModal: React.FC<{
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("C?p nh?t size th?t b?i!");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-mono-300 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md relative text-black">
        ...
        <h2 className="text-xl font-bold mb-6 text-center">C?p nh?t Size</h2>
    ...
    <div className="p-6 w-full font-sans">
      ...
      <div className="flex items-center justify-between border-b mb-4">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          >
            ...
            <option value="name_asc">Size tang d?n</option>
            <option value="name_desc">Size gi?m d?n</option>
          </select>
        ...
        <table className="min-w-full bg-white rounded-md overflow-hidden border">
          <thead className="bg-mono-50 text-mono-700 text-sm font-semibold uppercase">
            <tr>
              ...
              <th className="py-3 px-4 text-left border-b">Giá Tr?</th>
      ...
      <div className="flex items-center justify-between mt-6">
        <div className="text-sm text-mono-600">
          Trang {currentPage} / {totalPages} • T?ng: {totalCount} kích thu?c
        </div>
