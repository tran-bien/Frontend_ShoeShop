      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-mono-800 to-mono-black text-white p-6 rounded-t-xl">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold">Chi ti?t Màu s?c</h2>
            <button
              onClick={onClose}
...
const EditColorModal: React.FC<{
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("C?p nh?t màu th?t b?i!");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-mono-300 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md relative text-black">
        ...
        <h2 className="text-xl font-bold mb-6 text-center">C?p nh?t Màu</h2>
    ...
    <div className="p-6 w-full font-sans">
      ...
      <div className="flex items-center justify-between mt-6">
        <div className="text-sm text-mono-600">
          Trang {currentPage} / {totalPages} • T?ng: {totalCount} màu s?c
        </div>
