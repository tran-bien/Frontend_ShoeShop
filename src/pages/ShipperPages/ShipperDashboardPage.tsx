  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-mono-500">Ðang t?i...</div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-mono-600 text-sm mb-1">T?ng don hàng</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-mono-600 text-sm mb-1">T? l? thành công</p>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-mono-200">
          <h2 className="text-xl font-bold text-mono-800 flex items-center gap-2">
            ...
            Ðon hàng dang giao ({activeOrders.length})
          </h2>
        </div>
        <div className="p-6">
          {activeOrders.length === 0 ? (
            <div className="text-center py-8 text-mono-500">
              Không có don hàng nào dang giao
            </div>
          ) : (
