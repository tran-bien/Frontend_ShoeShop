    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center">
            {user?.avatar ? (
              ...
              <FaUser size={48} className="text-blue-600" />
            )}
          </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <p className="text-sm text-gray-600">Giới hạn đơn</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
              <FaTruck size={28} className="text-blue-600" />
            </div>
          ...
          <div className="text-center">
            <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
              <FaTimesCircle size={28} className="text-red-600" />
            </div>
            <p className="text-3xl font-bold text-red-600">
              {stats?.failed || 0}
            </p>
            <p className="text-sm text-gray-600 mt-1">Thất bại</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mt-1">Tỷ lệ TC</p>
          </div>
        </div>
      </div>
